...
\position{PhD in Computer Science, Model-Based Software Engineering} % Your expertise/fields
...
%\vspace{1cm}
\newpage \input{cv-sections/interests}
%\vspace{1cm}
