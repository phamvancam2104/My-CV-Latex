...
\position{PhD Student in Model Driven Software Engineering} % Your expertise/fields
...
\lettertitle{Job Application for Postdoctoral in Model-Driven Engineering} % The title of the letter
...
\makecvfooter{\today}{Van Cam. PHAM~~~·~~~Cover Letter}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
