...
{JAVA, C/C++ (especially for embedded systems), C\#, Androind, Xtend (Modernized Java), JavaScript, ASM, Matlab, Python, SQL} % Skills

%------------------------------------------------
\cvskill
{Framework and Tools} % Category
{Visual Studio, Eclipse (plug-in development), Java Spring, Spark, CodeBlocks, QT, TomCat, Android Studio, Oracle, NetBeans, VirtualBox, IBM Rhapsody, LaTeX, Papyrus} % Skills
